    ...
    if action in ['Start Game']:
        ...
        while True:
            ...
            if result == 'Back':
                ...
                if password == 'back':
                    continue  # Go back to multiplayer menu
                elif password:
                    settings_menu = GameSettingsMenu()
                    settings = settings_menu.run()
                    ...
                    if settings == 'back':
                        ...
                        if player_settings == 'back':
                            ...
                            game_room.add_player(this_player.id)  # Add host to room
                            game_engine = GameEngine(
                                game_mode=GameMode,
                                map_size=map_size,
                                players=players,
                ...
                if password == 'back':
                    ...
                    if not game_room or not game_room.verify_password(password):
                        continue  # Go back to multiplayer menu if password wrong
