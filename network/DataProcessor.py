...
class DataProcessor:
    ...
    def processing(self):
        ...
        timeout_counter = 0
        while self.number_received_packages < GameRoom.number_players and timeout_counter < 500: ## ADJUST
            ...
            if received:
                ...
                match packet[0][1]:
                    ...
                    case "map_request" if GameRoomManager().player_id == 0:
                        ...
                        ## somehow send the units and buildings #TODO
                        PacketManager().send_packet() 
                    ...
                    case "map" if self.game_engine and not self.game_engine.generated_map:
                        ...
                        ## somehow treat all the units and buildings ##TODO
